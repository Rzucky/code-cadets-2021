...
const userBetsPath = "/user/:id/bets"
const statusPath = "/bets"
...
func (w *WebServer) registerRoutes(ctrl Controller) {
	...
	w.router.GET(userBetsPath, ctrl.GetBetsByUserID())
	w.router.GET(statusPath, ctrl.GetBetByStatus())
...
type Controller interface {
	...
	GetBetByStatus() gin.HandlerFunc
}
